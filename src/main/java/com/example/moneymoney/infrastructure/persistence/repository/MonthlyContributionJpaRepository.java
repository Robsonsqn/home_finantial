...
public interface MonthlyContributionJpaRepository extends JpaRepository<MonthlyContributionJpaEntity, Long> {
    ...
    java.util.Optional<MonthlyContributionJpaEntity> findByHouseAndUserAndMonthAndYear(HouseJpaEntity house,
            com.example.moneymoney.infrastructure.persistence.entity.UserJpaEntity user, int month,
            int year);
}
